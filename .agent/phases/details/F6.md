...
- [ ] `docs/specification/design-principles.md` — the 7 principles with PL mappings
- [ ] `docs/specification/naming-conventions.md` — stdlib root verb table
- [ ] `docs/specification/type-sandhi.md` — formal type composition rules
- [ ] README/architecture doc references
