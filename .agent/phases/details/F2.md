# Phase F2 — Type System Completion
...
- Phase F1 (grammar spec) should ideally be written first or in parallel
- Phase F3 (object model) depends on this — trait bounds need generics
