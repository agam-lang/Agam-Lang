# Phase DX3 — Documentation Generation
...
- Phase F2/F3 (types and objects) — documentation needs types to document
- Phase F4 (modules) — module hierarchy drives documentation structure
