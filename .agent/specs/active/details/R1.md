# Phase R1 — Memory Model Decision and Implementation
...
- Phase F2 (type system) — generics needed for smart pointer types
- Phase F3 (object model) — struct semantics depend on memory model
