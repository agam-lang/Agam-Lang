# Phase AI4 — Cooperative Matrix / Tensor-Core Intrinsics
...
## Dependencies
- Phase O6 (SPIR-V Multi-Vendor GPU Path) — provides the foundation for portable SPIR-V emission.
- Phase F2 (Type System Completion) — requires advanced generics and type traits for matrix shapes and scalar types.
