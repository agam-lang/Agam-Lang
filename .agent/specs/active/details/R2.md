# Phase R2 — Async and Structured Concurrency
...
- Phase R1 (memory model) — concurrency safety depends on memory safety
- Phase F2 (type system) — `Future<T>` needs generics
